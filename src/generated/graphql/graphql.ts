...
export const useGetTaskByIdQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetTaskByIdQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetTaskByIdQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetTaskByIdQuery, TError, TData>(
      {
    queryKey: ['GetTaskById', variables],
    queryFn: graphqlFetch<GetTaskByIdQuery, GetTaskByIdQueryVariables>(GetTaskByIdDocument, variables),
    ...options
  }
    )};
...
export const useSuspenseGetTaskByIdQuery = <
      TData = GetTaskByIdQuery,
      TError = unknown
    >(
      variables: GetTaskByIdQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<GetTaskByIdQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<GetTaskByIdQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<GetTaskByIdQuery, TError, TData>(
      {
    queryKey: ['GetTaskByIdSuspense', variables],
    queryFn: graphqlFetch<GetTaskByIdQuery, GetTaskByIdQueryVariables>(GetTaskByIdDocument, variables),
    ...options
  }
    )};

useSuspenseGetTaskByIdQuery.getKey = (variables: GetTaskByIdQueryVariables) => ['GetTaskByIdSuspense', variables];

export const useInfiniteGetTaskByIdQuery = <
      TData = InfiniteData<GetTaskByIdQuery>,
      TError = unknown
    >(
      variables: GetTaskByIdQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetTaskByIdQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetTaskByIdQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetTaskByIdQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetTaskById.infinite', variables],
      queryFn: (metaData) => graphqlFetch<GetTaskByIdQuery, GetTaskByIdQueryVariables>(GetTaskByIdDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetTaskByIdQuery.getKey = (variables: GetTaskByIdQueryVariables) => ['GetTaskById.infinite', variables];

export const useSuspenseInfiniteGetTaskByIdQuery = <
      TData = InfiniteData<GetTaskByIdQuery>,
      TError = unknown
    >(
      variables: GetTaskByIdQueryVariables,
      options: Omit<UseSuspenseInfiniteQueryOptions<GetTaskByIdQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseInfiniteQueryOptions<GetTaskByIdQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseInfiniteQuery<GetTaskByIdQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetTaskById.infiniteSuspense', variables],
      queryFn: (metaData) => graphqlFetch<GetTaskByIdQuery, GetTaskByIdQueryVariables>(GetTaskByIdDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
...
useSuspenseInfiniteGetTaskByIdQuery.getKey = (variables: GetTaskByIdQueryVariables) => ['GetTaskById.infiniteSuspense', variables];


useGetTaskByIdQuery.fetcher = (variables: GetTaskByIdQueryVariables, options?: RequestInit['headers']) => graphqlFetch<GetTaskByIdQuery, GetTaskByIdQueryVariables>(GetTaskByIdDocument, variables, options);
...
export const useGetUserTasksQuery = <
      TData = GetUserTasksQuery,
      TError = unknown
    >(
      variables: GetUserTasksQueryVariables,
      options?: Omit<UseQueryOptions<GetUserTasksQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetUserTasksQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetUserTasksQuery, TError, TData>(
      {
    queryKey: ['GetUserTasks', variables],
    queryFn: graphqlFetch<GetUserTasksQuery, GetUserTasksQueryVariables>(GetUserTasksDocument, variables),
    ...options
  }
    )};

useGetUserTasksQuery.getKey = (variables: GetUserTasksQueryVariables) => ['GetUserTasks', variables];

export const useSuspenseGetUserTasksQuery = <
      TData = GetUserTasksQuery,
      TError = unknown
    >(
      variables: GetUserTasksQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<GetUserTasksQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<GetUserTasksQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<GetUserTasksQuery, TError, TData>(
      {
    queryKey: ['GetUserTasksSuspense', variables],
    queryFn: graphqlFetch<GetUserTasksQuery, GetUserTasksQueryVariables>(GetUserTasksDocument, variables),
    ...options
  }
    )};

useSuspenseGetUserTasksQuery.getKey = (variables: GetUserTasksQueryVariables) => ['GetUserTasksSuspense', variables];

export const useInfiniteGetUserTasksQuery = <
      TData = InfiniteData<GetUserTasksQuery>,
      TError = unknown
    >(
      variables: GetUserTasksQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetUserTasksQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetUserTasksQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetUserTasksQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetUserTasks.infinite', variables],
      queryFn: (metaData) => graphqlFetch<GetUserTasksQuery, GetUserTasksQueryVariables>(GetUserTasksDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetUserTasksQuery.getKey = (variables: GetUserTasksQueryVariables) => ['GetUserTasks.infinite', variables];

export const useSuspenseInfiniteGetUserTasksQuery = <
      TData = InfiniteData<GetUserTasksQuery>,
      TError = unknown
    >(
      variables: GetUserTasksQueryVariables,
      options: Omit<UseSuspenseInfiniteQueryOptions<GetUserTasksQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseInfiniteQueryOptions<GetUserTasksQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseInfiniteQuery<GetUserTasksQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetUserTasks.infiniteSuspense', variables],
      queryFn: (metaData) => graphqlFetch<GetUserTasksQuery, GetUserTasksQueryVariables>(GetUserTasksDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
...
useSuspenseInfiniteGetUserTasksQuery.getKey = (variables: GetUserTasksQueryVariables) => ['GetUserTasks.infiniteSuspense', variables];


useGetUserTasksQuery.fetcher = (variables: GetUserTasksQueryVariables, options?: RequestInit['headers']) => graphqlFetch<GetUserTasksQuery, GetUserTasksQueryVariables>(GetUserTasksDocument, variables, options);
