...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "h-8 w-full min-w-0 cursor-auto rounded-lg border border-border bg-transparent px-3 py-1 font-normal text-base text-secondary-foreground shadow-xs outline-none",
        ...
        "file:bg-transparent file:font-medium file:text-secondary-foreground focus-visible:border-primary",
