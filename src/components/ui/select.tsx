...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className="relative flex h-7 w-full select-none items-center gap-2 rounded-lg px-2 outline-hidden custom:hover:bg-surface hover:bg-muted custom:focus:bg-surface focus:bg-muted focus:text-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none"
      {...props}
    >
